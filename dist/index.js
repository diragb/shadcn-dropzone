...
var Dropzone = function (_a) {
    ...
    // Return:
    return (React__default["default"].createElement("div", __assign({}, dropzone.getRootProps(), { className: cn('flex justify-center items-center w-full h-32 border-dashed border-2 border-gray-200 rounded-lg hover:bg-accent hover:text-accent-foreground transition-all select-none cursor-pointer', className) }),
        React__default["default"].createElement("input", __assign({}, dropzone.getInputProps())),
        children ? (children(dropzone)) : (React__default["default"].createElement(React__default["default"].Fragment, null, dropzone.isDragAccept ? (React__default["default"].createElement("div", { className: 'text-sm font-medium' }, "Drop your files here!")) : (React__default["default"].createElement("div", { className: 'flex items-center flex-col gap-1.5' },
            React__default["default"].createElement("div", { className: 'flex items-center flex-row gap-0.5 text-sm font-medium' },
                React__default["default"].createElement(Upload, { className: 'mr-2 h-4 w-4' }),
                " Upload files"),
            props.maxSize && (React__default["default"].createElement("div", { className: 'text-xs text-gray-400 font-medium' },
                "Max. file size: ",
